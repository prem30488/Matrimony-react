...
import {fetchSolrEntitiesViewedDesc,fetchByMaritalStatus,fetchByMotherTounge,
...
class ViewedMyProfile extends Component {
    ...
    reloadUserList() {
        fetchSolrEntitiesViewedDesc(this.state.page,this.state.rowsPerPage)
            .then((res) => {
  ...
  <div className="container">
   <div className="breadcrumb1">
     <ul>
        ...
        <li className="current-page">Viewed My Profile</li>
     </ul>
   </div>
